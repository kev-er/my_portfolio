    ...
    return (
        ...
        className='relative w-full md:h-screen text-white h-unset'>
            ...
            <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full text-lg'>
                    ...
                    <p className="mb-4 py-6">Hi! I'm a self-taught Frontend Developer. In early 2020 I started learning how to code and discovered my love for coding & Linux. Learning is a big part of who I am. I love expanding my knowledge base and gaining as much expertise as I can in any given field. I am currently learning Neovim as my IDE and learning back-end with Nodejs </p>
